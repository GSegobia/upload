<?php
	...
	if(isset($_POST['submit'])!=""){
		...
		$link=$_POST['link'];
		move_uploaded_file($temp,"../updown/upload/".$name);
...
<html>
	...
	<body>
		<h2>TESTE</h2>
		<h3><p align="center">Upload And Download de Arquivos</p></h3> 
		...
		<table border="1" align="center" id="table1" cellpadding="0" cellspacing="0">
			...
			<?php
				$select=mysql_query("select * from upload order by id");
				while($row1=mysql_fetch_array($select)){
				$name=$row1['name'];
			?>
			<tr>
				<td width="300">
					<img src="tick.png" width="14" height="14"><a href="download.php?filename=<?php echo $name;?>">
					<?php echo $name ;?></a>
				</td>
			</tr>
			<?php }?>
